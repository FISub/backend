...
public interface MemberRepository extends JpaRepository<Member, String> {
        ...
        @Query(value = "SELECT mem_email, mem_name FROM member m JOIN subscription s on m.mem_num = s.mem_num WHERE s.mem_num = :memNum and s.sub_num = :subNum", nativeQuery = true)
        public List<Object[]> findMemEmailByMemNum(@Param("memNum") String memNum, @Param("subNum") String subNum);
}